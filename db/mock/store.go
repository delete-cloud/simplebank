...
// Source: github.com/delete-cloud/simplebank/db/sqlc (interfaces: Store)
//
...
// VerifyEmalTx mocks base method.
func (m *MockStore) VerifyEmalTx(ctx context.Context, arg db.VerifyEmalTxParams) (db.VerifyEmalTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyEmalTx", ctx, arg)
	ret0, _ := ret[0].(db.VerifyEmalTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// VerifyEmalTx indicates an expected call of VerifyEmalTx.
func (mr *MockStoreMockRecorder) VerifyEmalTx(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyEmalTx", reflect.TypeOf((*MockStore)(nil).VerifyEmalTx), ctx, arg)
}
