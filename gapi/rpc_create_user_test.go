...
import (
	...
	mockdb "github.com/delete-cloud/simplebank/db/mock"
	...
	mockwk "github.com/delete-cloud/simplebank/worker/mock"
...
func EqCreateUserTxParams(args db.CreateUserTxParams, password string, user db.User) gomock.Matcher {
	return eqCreateUserTxParamsMatcher{args: args, password: password, user: user}
}
